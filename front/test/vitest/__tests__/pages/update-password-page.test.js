...
import UpdatePasswordPage from 'src/pages/UpdatePasswordPage.vue'
...
describe('UpdatePasswordPage', () => {
  ...
  beforeEach(() => {
    ...
    profilStore = useProfilStore(pinia)
    profilStore.updatePassword.mockResolvedValue({ type: 'success', message: 'modification réussie' })
  ...
  it('devrait mettre à jour le mot de passe avec succès', async () => {
    ...
    expect(profilStore.updatePassword).toHaveBeenCalledWith('newpassword123')
  ...
  it('devrait afficher une erreur si les mots de passe ne correspondent pas', async () => {
    ...
    expect(profilStore.updatePassword).toBeCalledTimes(0)
  })
})
